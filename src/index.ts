...
try {
  ...
  // Red de seguridad final: cualquier rechazo que llegara hasta aquí
  // saldría como volcado crudo de Node. El usuario (o el log del cliente
  // MCP) siempre ve una línea concisa por stderr — stdout no se toca.
  console.error(
